...
def insertar_datos(ip_privada, ip_publica, nombre_usuario):
    ...
    conexion = mysql.connector.connect(
        host='serverdb.cwotauzs9htj.us-east-1.rds.amazonaws.com',  # Cambia por la dirección de tu servidor MySQL
        database='Datos',  # Cambia por el nombre de tu base de datos
        user='admin',  # Cambia por tu usuario de MySQL
